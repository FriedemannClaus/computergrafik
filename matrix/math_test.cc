...
TEST(VECTOR, Length4df) {
    Vector4df vector1 = {0.0, 1.0, 0.0, 0.0};
    auto length = vector1.length();

    EXPECT_NEAR(1.0, length, 0.00001);
}

TEST(VECTOR, SquareOfLength4df) {
    Vector4df vector = {2.0, 3.0, 3.0, 2.0};
    EXPECT_NEAR(26.0, vector.square_of_length(), 0.00001);
}

TEST(VECTOR, ScalarVectorProduct4df) {
    Vector4df vector1 = {1.0, 2.0, -1.0, 3.0};
    Vector4df vector2 = {-1.0, 1.0, 3.0, 2.0};

    float scalar = vector1 * vector2;

    EXPECT_NEAR(4.0, scalar, 0.00001);
    EXPECT_NEAR(1.0, vector1[0], 0.00001);
    EXPECT_NEAR(2.0,  vector1[1], 0.00001);
    EXPECT_NEAR(-1.0, vector1[2], 0.00001);
    EXPECT_NEAR(-1.0, vector2[0], 0.00001);
    EXPECT_NEAR(1.0,  vector2[1], 0.00001);
    EXPECT_NEAR(3.0, vector2[2], 0.00001);
    EXPECT_NEAR(3.0,  vector1[3], 0.00001);
