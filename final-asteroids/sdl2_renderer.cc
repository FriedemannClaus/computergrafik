...
void SDL2Renderer::renderSpaceship(Vector2df position, float angle) {
  ...
  */
    ...
    //own ship points
    static std::array<SDL_Point, 7> ship_points{SDL_Point{-4, 3}, //scaled the ship down to make the weapon fit in the hitbox
                                                SDL_Point{-4,-3},
                                                SDL_Point{-6,-6},
                                                SDL_Point{ 8, 0},
                                                SDL_Point{-6, 6},
                                                SDL_Point{-4, 3},
                                                SDL_Point{20, 0} //additional 7th "weapon" point
                                                };
...
void SDL2Renderer::renderScore() {
  ...
  do {
    ...
    x -= 20;
      ...
      // here, yellow, draw, white again. Es ist die Punkte-Anzeigefarbe
